...
\begin{description}
    ...
    \item[IA \& HPC] cards com servidores de inteligência
          ...
          Instinct MI300X, Google TPU v5p e o supercomputador
          \emph{Frontier} (exaescala).
\end{description}
...
QPI             & Intel 2008--2017 & 25,6 GB/s  & MESIF (4 camadas) \\
...
\begin{description}
    ...
    \item[Como funciona (Hamming)] mostra os 12 bits da palavra
          Hamming(12,8): quatro paridades $P_1, P_2, P_4, P_8$ nas
          posições $2^k$, oito bits de dado, e uma tabela com as
          posições cobertas por cada paridade.
    \item[Soft errors no mundo real] expõe os números do estudo de
          Schroeder \textit{et al.}~\cite{schroeder2009} e cita o
          caso da eleição de Schaerbeek (Bélgica, 2003) com
          \emph{bit flip} no contador.
